...
$countGames = $mysqli->query('SELECT COUNT(*) as c FROM resultados')->fetch_assoc()['c'] ?? 0;
$countNews = $mysqli->query('SELECT COUNT(*) as c FROM noticias')->fetch_assoc()['c'] ?? 0;
      ...
      <div class="col-sm-6">
        <div class="card mb-3">
          <div class="card-body">
            ...
            <a href="add_resultado.php" class="btn btn-primary">Gerir Jogos</a>
          </div>
        </div>
      </div>
      <div class="col-sm-6">
